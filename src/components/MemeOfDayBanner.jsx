...
export default function MemeOfDayBanner() {
  ...
  return (
    <div aria-label="Meme of the day" className="flex items-center gap-3 rounded-2xl border border-edge bg-panel px-3 py-2.5">
      ...
      <span className="hidden shrink-0 items-center gap-1 rounded-full bg-brand-fill px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-widest text-ink sm:inline-flex">
