    ...
    <>
      ...
      <PolicyLayout title="Disclaimer" lastUpdated="August 2026" breadcrumb="Disclaimer">
        ...
        <PolicySection heading="Third-Party Content">
          <p>Some content on Videsaur may originate from third-party sources. We take DMCA notices seriously and promptly remove infringing content upon verified request. If you believe content infringes your rights, please contact <a href="mailto:dmca@videsaur.co.in" className="text-brand hover:underline">dmca@videsaur.co.in</a>.</p>
        </PolicySection>
